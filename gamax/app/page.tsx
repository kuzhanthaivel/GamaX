          ...
          <section className="flex flex-row items-center justify-center px-24 py-20 gap-6">
            <div className="flex-col gap-5 flex">
              ...
              <div className="flex justify-center lg:justify-start space-x-4">
                <button className="bg-indigo-500 hover:bg-indigo-600 px-6 py-3 rounded-lg transition">Explore</button>
                <button className="border border-indigo-500 hover:bg-indigo-700 px-6 py-3 rounded-lg transition">Create</button>
              </div>
            </div>
